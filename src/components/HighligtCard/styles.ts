...
export const Container = styled.View<IColorType>`
...
`;
export const Title = styled.Text<IColorType>`
...
export const Icon = styled(Feather)<IColorType>`
...
`;
export const Amount = styled.Text<IColorType>`
  font-family: ${({theme})=>theme.fonts.medium};
  font-size: ${RFValue(32)}px;
  color: ${({theme, type})=>type === 'total' ?theme.colors.shape:theme.colors.text_dark};
  margin-top: 38px;
`;
export const LastTransaction = styled.Text<IColorType>`
font-family: ${({theme})=>theme.fonts.regular};
